/// 下载媒体信息基类
abstract class DownloadMediaInfo {
...
/// Type1: FLV格式
class Type1MediaInfo extends DownloadMediaInfo {
  ...
  factory Type1MediaInfo.fromJson(Map<String, dynamic> json) => Type1MediaInfo(
        ...
        playerCodecConfigList:
            (json['player_codec_config_list'] as List<dynamic>)
                .map((e) =>
                    Type1PlayerCodecConfig.fromJson(e as Map<String, dynamic>))
                .toList(),
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
        ...
        'player_codec_config_list':
            playerCodecConfigList.map((e) => e.toJson()).toList(),
...
/// Type2: DASH格式
class Type2MediaInfo extends DownloadMediaInfo {
  final int duration;
  ...
  factory Type2MediaInfo.fromJson(Map<String, dynamic> json) => Type2MediaInfo(
        duration: json['duration'] as int,
...
/// 错误信息
class NoneMediaInfo extends DownloadMediaInfo {
